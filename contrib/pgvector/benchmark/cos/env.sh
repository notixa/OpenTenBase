#!/bin/bash
# Cosine (GloVe-100 angular) scenario — full self-contained config (no parent deps).
# Paths derived from this file: <repo>/contrib/pgvector/benchmark/cos/env.sh
...
# scenario-specific
export SCENARIO="cos"
export TABLE="glove_base"
export OPCLASS="vector_cosine_ops"
export OP="<=>"
export DATASET_URL="http://ann-benchmarks.com/glove-100-angular.hdf5"
